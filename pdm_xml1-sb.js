...
///var xml_file = "/ГОСТ.xml";
//var xml_file = "/xml_files/test.xml";
//var xml_file = "/xml_files/test2.xml";
//var xml_file = "/xml_files/КСЦ50.01.100 Опора.xml";
//var xml_file = "/xml_files/Стандартные и прочие изделия (27.08.2014).xml";
//var xml_file = "/xml_files/КСЦ50.00.000 Конвейер скребковый цепной (27.08.2014).xml";
//var xml_file = '/xml_files/Стандартные и прочие изделия (15.08).xml';
//var xml_file = "/xml_files/Материалы (03.11.2013).xml";

//var xml_file = "/xml_files/ЗC975.08.00.000 СБ Блок вентиляторов (11.02.2015).xml";
//var xml_file = "/xml_files/ЗС1175.04.00.000 СБ Модуль верхний (26.02.2015).xml";

// 03.2015
// var xml_file = "/xml_files/ЗC975.00.00.000 СБ.xml";
var xml_file = "/xml_files/КСЦ150С.xml";
//var xml_file = "/xml_files/ЗC975.00.00.000 СБ.xml";  // слишком большой

//var xml_file = "/xml_files/ЗС1175.04.00.000 СБ Модуль верхний (04.03.2015).xml";

//var xml_file = "/xml_files/ЗC975.00.00.000 (без вложений) 05.03.2015.xml";
//var xml_file = "/xml_files/СЗ975.00.00.200 СБ Опора.xml";

//var xml_file = "/xml_files/ЗС975 часть (05.03.2015).xml";


//var xml_file = "/xml_files/КСЦ 450 (29.01.2015).xml";
//var xml_file = "/xml_files/Стандартные и прочие изделия (24.10.2014).xml";


var tabs = '';
var counter = 0;
var el = [];
var pathToFile = __dirname + xml_file;
...
function printAllElementsSB() {
    ...
    //console.log(allDT); //вывод на печать массива всех джеталей
}
